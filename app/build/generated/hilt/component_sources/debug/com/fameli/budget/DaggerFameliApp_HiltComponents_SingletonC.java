    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new FamilyViewModel(singletonCImpl.familySyncRepositoryProvider.get());
          ...
          return (T) new SettingsViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.firebaseAuthRepositoryProvider.get(), singletonCImpl.categoryDao());

          case 8: // com.fameli.budget.ui.screens.statistics.StatisticsViewModel 
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new FamilySyncRepository(singletonCImpl.provideFirestoreProvider.get(), singletonCImpl.firebaseAuthRepositoryProvider.get(), singletonCImpl.transactionDao(), singletonCImpl.categoryDao(), singletonCImpl.taskDao());
